...
if($_SERVER["REQUEST_METHOD"] == "POST"){
		...
		{
			$err_number="Customer ID is Required.";
			$err = true;
		}
...
<html>
	<body>
	<fieldset><legend align="center"><h1>Customer Registration</h1></legend>
	...
	<form action="" method="post">
		<table align="center" >
			...
			<tr>
				...
				<td> <input type="numeric" Placeholder="CustomerID" name="number" value="<?php echo $number;?>">
